          ...
          if (xc > 0)
            {
              ...
              proj[90+alpha][RayNum] +=
                      orig[imageWidth-1-ix-dx][iy+dy] * hy;

              if(RayNum != midray){

                  proj[alpha][projWidth-1-RayNum] +=
                          orig[imageWidth-1-iy-dy][imageWidth-1-ix-dx] * hy;

                  proj[90+alpha][projWidth-1-RayNum] +=
                          orig[ix+dx][imageWidth-1-iy-dy] * hy;
              }
              ...
              if(alpha != 45){
                  ...
                  proj[180 - alpha][RayNum] +=
                          orig[imageWidth-1-iy-dy][ix+dx] * hy;

                  if(RayNum != midray){

                      proj[90-alpha][projWidth-1-RayNum] +=
                              orig[imageWidth-1-ix-dx][imageWidth-1-iy-dy] * hy;

                      proj[180 - alpha][projWidth-1-RayNum] +=
                              orig[iy+dy][imageWidth-1-ix-dx] * hy;
                  }
              }
              w -= hy;
              ix += incx;
          ...
          else
            {
              ...
              proj[90+alpha][RayNum] +=
                      orig[imageWidth-1-ix-dx][iy+dy] * w;

              if(RayNum != midray){

                  proj[alpha][projWidth-1-RayNum] +=
                          orig[imageWidth-1-iy-dy][imageWidth-1-ix-dx] * w;

                  proj[90+alpha][projWidth-1-RayNum] +=
                          orig[ix+dx][imageWidth-1-iy-dy] * w;
              }
              ...
              if(alpha != 45){
                  ...
                  proj[180 - alpha][RayNum] +=
                          orig[imageWidth-1-iy-dy][ix+dx] * w;

                  if(RayNum != midray){

                      proj[90-alpha][projWidth-1-RayNum] +=
                              orig[imageWidth-1-ix-dx][imageWidth-1-iy-dy] * w;

                      proj[180 - alpha][projWidth-1-RayNum] +=
                              orig[iy+dy][imageWidth-1-ix-dx] * w;
                  }
              }
              w = hy - w;
              iy++;
...
//            proj[alpha][RayNum] += orig[iy][ix] * hx;
              ...
              proj[90+alpha][RayNum] +=
                      orig[imageWidth-1-ix-dx][iy+dy] * hx;

              if(RayNum != midray){

                  proj[alpha][projWidth-1-RayNum] +=
                          orig[imageWidth-1-iy-dy][imageWidth-1-ix-dx] * hx;

                  proj[90+alpha][projWidth-1-RayNum] +=
                          orig[ix+dx][imageWidth-1-iy-dy] * hx;
              }
              ...
              if(alpha != 45){
                  ...
                  proj[180 - alpha][RayNum] +=
                          orig[imageWidth-1-iy-dy][ix+dx] * hx;

                  if(RayNum != midray){

                      proj[90-alpha][projWidth-1-RayNum] +=
                              orig[imageWidth-1-ix-dx][imageWidth-1-iy-dy] * hx;

                      proj[180 - alpha][projWidth-1-RayNum] +=
                              orig[iy+dy][imageWidth-1-ix-dx] * hx;
                  }
              }
              iy++;
              //next = 2;
