...
void generate_parallel_sphere()
{
    ...
    char parallel_circle_json[] = "test_360x128x128_128_parallel_sphere.json";
...
void generate_parallel_ellipse()
{
    ...
    char parallel_circle_json[] = "test_360x128x128_128_parallel_ellipse.json";
...
void generate_parallel_taiji()
{
    ...
    char parallel_circle_json[] = "test_360x128x128_128_parallel_taiji.json";
